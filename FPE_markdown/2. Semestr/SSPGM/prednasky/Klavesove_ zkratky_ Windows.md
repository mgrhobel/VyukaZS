---
title: "Klavesove_ zkratky_ Windows.pdf"
source: "/mnt/f/git/mgr/FPE_navazujici/2. Semestr/SSPGM/prednasky/Klavesove_ zkratky_ Windows.pdf"
date: 2009-02-19
type: PDF (text-based)
---
...
F6 - v průzkumníku dochází k přepínání mezi jednotlivými částmi okna (menu,
adresa, objekty)
Num Lock - stisknutím této klávesy na dobu delší, než pět sekund, dojde k
ozvučení těchto kláves: Caps Lock, Num Lock a Scrool Lock
Delete - odstranění dokumentu či textu
CTRL+Esc - otevření Start menu
CTRL+A - vybere všechny položky v okně (ve Wordu např. označí veškerý
text), vhodné pro kopírování do schránky
CTRL+levý klik myši - přidržením klávesy CTRL a klikáním na objektů dojde k
postupnému hromadnému označování objektů
...
Backspace (šipka vlevo, nad entrem) - zobrazí složky o úroveň výš (v Tomto
počítači nebo Průzkumníku)
...
ALT+Enter - je-li označen jakýkoliv objekt (soubor, adresář), zobrazí se jeho
vlastnosti
ALT+TAB - přepnutí do naposledy používaného okna. Přidržením těchto
kláves se zobrazí všechna otevřená okna
ALT+ESC - přepínání mezi okny v pořadí, ve kterém byly spuštěny
ALT+F4 - zavření okna či programu
ALT+podtržené písmeno - podržením klávesy ALT a odpovídajícího písmena
dojde k akci v nabídce, pod kterou spadá
...
CTRL+Z - krok zpět. Zrušení poslední akce (opakováním kl. zkratky dochází k
dalšímu zrušení akce)
...
CTRL+Enter - automaticky do adresy doplní řetězce www a cz (v případě, že
máte českou verzi)
...
SHIFT - přidržíte-li tuto klávesu při vkládání CD obsahujícího autorun
(samospustitelné CD), nedojde k jeho spuštění
ALT+Space (mezerník) - vyvolá systémovou nabídku aktivního okna. V něm
můžete provádět tyto funkce: obnovit, minimalizovat, zavřít atd.
ALT+mínus - stejná funkce jako s mezerníkem. Funguje jen v některých
programech
ALT+šipka - otevře nabídku lišty
CTRL+F4 - zavře podrodičovská okna (např. ve Wordu dojde k uzavření
otevřeného dokumentu, ale program zůstane i nadále aktivní)
ALT+F6 - přepínání mezi podrodičovskými okny (např. ve Wordu se tímto
způsobem lze přepínat mezi otevřenými dokumenty)
...
Windows 7 obecně
Přenést fokus (zaměření ovládané klávesnicí) do oblasti ikon vedle
Win + B
hodin
Win + D
Přenést plochu do popředí
Otevřít Průzkumníka, výchozí je pohled na uživatelské knihovny
Win + E
(Libraries)
Win + F
Otevřít okno Vyhledávání
nové ve Windows 7: Přenést fokus na miniaplikaci (gadget) na
Win + G
Ploše
Win + L
...
nové ve Windows 7: Nastavit zobrazení druhého monitoru
Win + P
(vypnout/duální režim/rozšířená plocha/jen externí monitor)
Win + R
Otevřít okno Spustit program
upravena funkce ve Windows 7: Přejít na hlavní panel a je-li
Win + T
patřičná ikona spuštěna, zobrazit náhled programu (či případně
náhled více oken programu)
Win + U
...
upravena funkce ve Windows 7: Při držené klávese Win zprůhlední
Win + Mezerník
všechna okna, aby byla vidět plocha a miniaplikace na ploše
Win + Pause
Zobrazit vlastnosti systému
Za stálého držení klávesy Alt přepínat na další okna aplikací (po
Alt + Tab
uvolnění bude pořadí upraveno)
Za stálého držení klávesy Alt přepínat na předchozí okna aplikací
Alt + Shift + Tab
(po uvolnění bude pořadí upraveno)
Stejné, jako Alt + Tab, ale klávesy lze následně uvolnit a zvolit
Ctrl + Alt + Tab
aplikaci šipkami nebo myší
Za stálého držení klávesy Win přepínat prostorově na další okna
Win + Tab
aplikací (po uvolnění zůstane pořadí zachováno)
Za stálého držení klávesy Win přepínat prostorově na předchozí
Win + Shift + Tab
okna aplikací (po uvolnění zůstane pořadí zachováno)
Stejné, jako Win + Tab, ale klávesy lze následně uvolnit a zvolit
Ctrl + Win + Tab
aplikaci šipkami nebo myší
...
Při přejmenování souboru TAB způsobí uložení změn a přechod na
F2, TAB
další soubor.
F3
...
Alt + šipka vlevo Zpět (na předchozí zobrazenou složku)
Alt + šipka
Vpřed
vpravo
Alt + šipka
...
Zavření záložky, je-li zobrazena jediná, pak uzavření Internet
Ctrl + F4
Exploreru
Alt + F4
...
Ctrl + ikona
Klepnutí na ikonu maximalizovat současně s klávesou Ctrl
maximalizovat
provede přepnutí do celoobrazovkového režimu (jako F11)
Ctrl + A
...
Exploreru (stejné jako Ctrl + F4)
Ctrl + Num+
Zvětšení měřítka
Ctrl + NumZmenšení měřítka
Nastavení měřítka na 100 % (nelze použít nulu na numerické
Ctrl + 0
klávesnici)
Přechod na záložku 1 až 9 (nelze použít čísla na numerické
Ctrl + 1...9
klávesnici)
Ctrl + Num5
...
Ctrl + Tab
Další záložka
Ctrl + Shit + Tab Předchozí záložka
Mezerník
Posunou o obrazovku dolů (jako PageDown)
Shift + Mezerník Posunou o obrazovku nahoru (jako PageUp)
